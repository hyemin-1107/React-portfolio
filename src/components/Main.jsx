          ...
          <>
            ...
            <ProfileText>
              ...
              <ProfileTextAbout>
                <div>
                  안녕하세요! <br />
                  저는 어릴 적부터 무언가 그리고 만드는 것을 좋아했습니다. <br />             
                  백지 상태에서 나만의 세상을 그려나가는 과정이 즐거웠고, <br />
                  이것이 제 삶의 큰 부분을 차지하게 되었습니다.
                </div>
                <div>
                  퍼블리셔 수업을 시작으로 JavaScript를 접하게 되어 프로그래밍에 <br />
                  발을 디뎠습니다. 이렇게 시작한 공부는 확장되어 Front-End까지 <br /> 
                  관심을 가지게 되었습니다.
                </div>
                <div>
                  웹 개발을 공부하면서 항상 사용자의 입장에서 생각하는 습관을
                  들였습니다. 웹 접근성과 표준화를 중요하게 생각하고, 이를 바탕으로 <br /> 
                  사용자 친화적인 웹 페이지를 제작하는 것을 목표로 하고 있습니다.
                </div>
              </ProfileTextAbout>
            </ProfileText>
          </>
